...
function HiddenLevel(previousWork) {
...
gEngine.Core.inheritPrototype(HiddenLevel, Scene);
...
HiddenLevel.prototype.initialize = function () {
    ...
    this.UIText = new UIText("This is Hidden level", [600, 220], 8, 1, 0, [0, 0, 0, 1]);
...
HiddenLevel.prototype.gameSceneSelect = function () {
    this.LevelSelect = "Game";
    gEngine.GameLoop.stop();
};
//
// HiddenLevel.prototype.physicsSelect = function(){
//     this.LevelSelect="Physics";
//     gEngine.GameLoop.stop();
// };
//
// HiddenLevel.prototype.uiSelect= function(){
//     this.LevelSelect="UI";
//     gEngine.GameLoop.stop();
// };